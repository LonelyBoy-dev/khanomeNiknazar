...
@section('content')
    <!-- Column -->
    <form class="row" action="{{route('users.store')}}" method="post" autocomplete="off" enctype="multipart/form-data">
        @csrf
                ...
                <div class="" style="text-align: center">
                    ...
                    <div style="margin-bottom: 0">
                        ...
                        <div class="switch" align="center" style="margin: 15px 0">
                            <label><span style="float: left">غیر فعال</span><input id="active_user" name="status" type="checkbox" checked><span class="lever switch-col-green"></span><span style="float: right">فعال</span></label>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="form-horizontal form-material">
                            ...
                            {{--<div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" name="family" value="{{old('family')}}" placeholder="نام خانوادگی را وارد کنید" class="form-control form-control-line">
                                    @error('family')
                                    <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="password" value="{{old('password')}}" name="password" placeholder="رمز ورود را وارد کنید" class="form-control form-control-line">
                                    @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="password" value="{{old('password_confirmation')}}" name="password_confirmation" placeholder="تکرار رمز ورود را وارد کنید" class="form-control form-control-line">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <button style="float: left" class="btn btn-success">افزودن کاربر</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('script')
    ...
    <script>
        function uploadImageUser_New(){
            uploadImageUserNew('{{csrf_token()}}')
        }
    </script>
@endsection
