        ...
        <div class="col-12">
            <div class="card-body header-button-group">
                <div class="button-group">
                    <a href="/admin/admins/create" type="button" class="btn btn-primary"><i class="mdi mdi-plus"></i> افزودن جدید</a>
                                    ...
                                    <table class="table table-bordered" data-page="<?= $pageNum+1?>">
                                        ...
                                        @foreach($items as $item)
                                            <tr id="item{{$item->id}}">
                                                ...
                                                <td>
                                                    @if($item->avatar=="")
                                                        <img src="{{asset('admin-panel/images/users/profile.png')}}" style="width: 30px;border-radius: 100%">
                                                    @else
                                                ...
                                                <td class="text-nowrap">
                                                    ...
                                                    <a href="{{route('admins.edit',$item->id)}}" data-toggle="tooltip" data-original-title="ویرایش" > <i class="fa fa-pencil text-inverse m-r-10"></i> </a>
