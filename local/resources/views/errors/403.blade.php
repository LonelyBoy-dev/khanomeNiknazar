...
<style>
    @font-face {
        font-family: Vazir;
        src: url('{{asset('admin-panel/fonts/Vazir/Vazir.eot')}}');
        src: url({{asset('admin-panel/fonts/Vazir/Vazir.eot?#iefix')}}) format('embedded-opentype'),
        url({{asset('admin-panel/fonts/Vazir/Vazir.woff')}}) format('woff'),
        url({{asset('admin-panel/fonts/Vazir/Vazir.ttf')}}) format('truetype');
        font-weight: normal;
    }

    input, a, h1, h2, h3, h4, h5, h6, button, p, li, ul, span {
...
<h2 dir="rtl"> <a href="/admin/dashboard"><< برگشت به صفحه نخست >></a></h2>
