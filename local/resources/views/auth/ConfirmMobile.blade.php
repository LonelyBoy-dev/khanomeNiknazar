                            ...
                            <div class="row align-items-center justify-content-center">
                                ...
                                <div class="col-md-12 col-lg-6 login-right">
                                    <div class="login-header">
                                        ...
                                        <p class="small text-muted"> کد پنج رقمی به شماره {{session('UserHairStylistInfo')['mobile']}} ارسال شد</p>
                                    </div>

                                    <!-- Forgot Password Form -->
                                    <form method="POST" action="/register/hairStylist/ConfirmMobile/checkCode">
                                        @csrf
                                        <div class="form-group form-focus">
                                            <input id="code" type="text" autofocus {{--onkeyup="toEnglishNumber(this.value,'code')"--}} class="form-control floating @error('code') is-invalid @enderror" name="code" value="{{ old('code') }}" required  autocomplete="off" >
