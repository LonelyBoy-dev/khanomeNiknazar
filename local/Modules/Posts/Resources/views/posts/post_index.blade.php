        ...
        <div class="col-12">
            <div class="card-body header-button-group">
                <div class="button-group">
                    <a href="/admin/posts/create" type="button" class="btn btn-primary"><i class="mdi mdi-plus"></i> افزودن جدید</a>
                </div>
            </div>
            <div class="card">
                <div class="card-body">
                    <div class="row operation">
                        ...
                        <form style="display: contents;" method="get" action="/admin/posts">
...
<!--                                                <td><span class="label label-success">{{$item->view}}</span></td>-->
                                                ...
                                                <td class="text-nowrap">
                                                    <a href="{{route('posts.edit',$item->id)}}" data-toggle="tooltip" data-original-title="ویرایش"> <i class="fa fa-pencil text-inverse m-r-10"></i> </a>
