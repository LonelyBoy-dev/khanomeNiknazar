...
@section('content')
    <div class="row">
        <div class="col-12">
            ...
            <form class="row" method="POST" action="{{route('posts.update',$item->id)}}">
                @csrf
                {{ method_field('PATCH') }}
                        ...
                        <div class="card-body">
                            <div class="form-horizontal form-material">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="level" value="@if(old('level')){{old('level')}}@else{{$item->level}}@endif"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <textarea name="content" id="editor1" placeholder="توضیحات مطلب را وارد کنید"
                                                  class="form-control" rows="20">@if(old('content')){{old('content')}}@else{{$item->content}}@endif</textarea>
                                    </div>
                                </div>-->
                                <div class="form-group">
                                    <label class="col-md-12">لینک</label>
                                    <div class="col-md-12">
                                        <input type="text" name="link" value="@if(old('link')){{old('link')}}@else{{$item->link}}@endif"
                                ...
                                <div class="form-group m-0">
                                    ...
                                    <div class="col-md-12">
                                        <textarea name="shortContent" placeholder="شرح مختصر (توضیحی کوتاه از نوشته) را وارد کنید"
                                                  class="form-control" rows="5">@if(old('shortContent')){{old('shortContent')}}@else{{$item->shortContent}}@endif</textarea>
                                    </div>
                                </div>
                            </div>
...
<!--                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-horizontal form-material">
                                <div class="form-group">
                                    <label class="col-md-12">عنوان سئو</label>
                                    <div class="col-md-12">
                                        <input type="text" name="seoTitle" value="@if(old('seoTitle')){{old('seoTitle')}}@else{{$item->seoTitle}}@endif" placeholder="عنوان سئو را وارد کنید"
                                               class="form-control form-control-line">
                                    </div>
                                </div>

                                <div class="form-group m-0">
                                    <label class="col-md-12">توضیحات سئو</label>
                                    <div class="col-md-12">
                                        <textarea name="seoContent" placeholder="توضیحات سئو را وارد کنید"
                                                  class="form-control" rows="5">@if(old('seoContent')){{old('seoContent')}}@else{{$item->seoContent}}@endif</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-horizontal form-material">
                                <div id="sounds" class="form-group ">
                                    ...
                                    @if(old('sounds'))
                                        ...
                                        @endforeach
                                    @else
                                        @php $sounds=explode('||',$item->sounds) @endphp
                                        @foreach($sounds as $key=>$row)
                            ...
                            <div class="form-horizontal form-material">
                                <div id="links" class="form-group ">
                                    ...
                                    @if(old('links'))
                                        ...
                                        @endforeach
                                    @else
                                        @php $links=explode('||',$item->links) @endphp
                ...
                <div class="col-lg-4 col-xs-12 col-sm-12">
                            ...
                            <div class="form-horizontal form-material">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="status">
                                        <option @if(old('status'))@if(old('status')=="PUBLISHED") selected @endif @else @if($item->status=="PUBLISHED") selected @endif @endif value="PUBLISHED" >انتشار</option>
                                        <option @if(old('status'))@if(old('status')=="DRAFT") selected @endif @else @if($item->status=="DRAFT") selected @endif @endif value="DRAFT">پیش نویس</option>
                                    </select>
                                </div>
                                <div class="form-group m-0">
                                    <div class="col-md-12">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <input <?php
                                                               if (old('category')){
                                                                   ...
                                                                   foreach ($item->postcategories as $category_id){
                                                               ...
                                                               ?>
                                                               type="checkbox" id="md_checkbox_{{$category->id}}" name="category[]" class="filled-in chk-col-deep-purple" value="{{$category->id}}">
                                                        <label for="md_checkbox_{{$category->id}}">{{$category->title}}</label>
                                                    </div>
                                                @endforeach
                                        </div>
                                    </div>
                                    ...
                                    <div class="p-r-10">
                                        <div class="scroll-sidebar p-b-0" style="overflow: hidden; width: auto; max-height: 235px">
                                            <div style="margin-bottom: 2px">
                                                <input type="radio" id="target1" name="target" @if(old('target')=="1") checked @elseif($item->target==1) checked @endif value="1" class="filled-in chk-col-deep-purple">
                                                <label for="target1">آزمون دارم</label>
                                            </div>
                                            <div style="margin-bottom: 2px">
                                                <input type="radio" id="target2" name="target" @if(old('target')=="2") checked @elseif($item->target==2) checked  @endif value="2" class="filled-in chk-col-deep-purple">
                    ...
                    <div class="card examdiv @if(old('target')) @if(old('target')!="1") hide @endif @elseif($item->target!=1) hide @endif ">
                        <div class="card-body">
                            <div class="form-horizontal form-material">
                                <div class="form-group">
                                                ...
                                                <div style="margin-bottom: 2px">
                                                    <input <?php
                                                           if (old('exam')){
                                                               ...
                                                               foreach ($item->postexams as $exam_id){
                                                                   if ($exam->id == $exam_id->id){
                                                                       echo 'checked';
                                                                   }
                                                               }
                                                           }
                    ...
                    <div class="card notexamdiv @if(old('target')) @if(old('target')!="2") hide @endif @elseif($item->target!=2) hide @endif">
                        <div class="card-body">
                            <div class="form-horizontal form-material">
                                <div class="form-group">
                                                ...
                                                <div style="margin-bottom: 2px">
                                                    <input <?php
                                                           if (old('notexam')){
                                                               ...
                                                               foreach ($item->postnotexams as $notexam_id){
                                                                   if ($notexam->id == $notexam_id->id){
                                                                       echo 'checked';
                                                                   }
                                                               }
                                                           }
                                                ...
                                                <div style="margin-bottom: 2px">
                                                    <input <?php
                                                           if (old('score')){
                                                               ...
                                                               foreach ($item->postscores as $score_id){
                                                                   if ($score->id == $score_id->id){
                                                                       echo 'checked';
                                                                   }
                                                               }
                                                           }
                                                ...
                                                <div style="margin-bottom: 2px">
                                                    <input <?php
                                                           if (old('module')){
                                                               ...
                                                               foreach ($item->postmodules as $module_id){
                                                                   if ($module->id == $module_id->id){
                                                                       echo 'checked';
                                                                   }
                                                               }
                                                           }
                        ...
                        <div class="card-body">
                            <div class="form-horizontal form-material">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" id="feature_image" name="feature_image" value="@if(old('feature_image')){{old('feature_image')}}@else{{$item->image}}@endif">
                                    <a  data-inputid="feature_image" data-path="{{asset('')}}" class="popup_selector popup-selector-image-box feature_image">
                                        ...
                                        @if(old('feature_image') or $item->image)<div class="img-after-upload"><img class="card-img-top img-responsive " src="@if(old('feature_image')){{asset(old('feature_image'))}}@else{{asset($item->image)}}@endif" alt="Card image cap"></div> @endif
                                        <div id="remove-icon">
                                            @if(old('feature_image') or $item->image)<span onclick="remove_image(this)" class="remove-img-after-upload"><i class="mdi mdi-close-circle"></i>حذف</span> @endif
                                        </div>
                                    </a>
